package com.xwjr.utilcode.okhttp.builder;


import com.xwjr.utilcode.okhttp.OkHttpUtils;
import com.xwjr.utilcode.okhttp.request.PostStringRequest;
...
public class PostStringBuilder extends OkHttpRequestBuilder {
    ...
    public PostStringBuilder addParams(String key, String val) {
        ...
        params.put(key, val);
        LogUtils.i(OkHttpUtils.class.getSimpleName(),"key= "+key+",val= "+val);
        return this;
    }
