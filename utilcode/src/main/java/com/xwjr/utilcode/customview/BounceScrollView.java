...
public class BounceScrollView extends ScrollView {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        LogUtils.i("inner是什么："+(inner!=null));
    ...
    public void commOnTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                LogUtils.i("isNeedMove:"+isNeedMove()+"\n"+
                "向上拖拽大于300距离:"+(ev.getY() - downY)+"\n");
...
//                }
                ...
                if (isNeedMove()) {
                    ...
                    //如果向上拖拽大于300距离，触发监听事件
                    if (ev.getY() - downY < -300) {
                        //防止多次触发
                        if (System.currentTimeMillis() - actionTime > 1000){
    ...
    private ScrollHideListener scrollHideListener;

    public interface ScrollHideListener {
        void ScrollHide();
    }

    public void setScrollHideListener(ScrollHideListener scrollHideListener) {
