...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    private float downX;
    private int lastX;
    private boolean isSlide;//判断是否在左右滑动

    private boolean canSlide = true;//是否允许左右滑动，默认true
    ...
    public void refreshFinish(int refreshResult) {
        ...
        if (refreshStateImageView != null && refreshStateTextView != null) {
    ...
    public interface SlideListener {
        void leftSlide(PullToRefreshLayout pullToRefreshLayout);

        void rightSlide(PullToRefreshLayout pullToRefreshLayout);
