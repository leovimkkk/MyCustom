...
public class GestureLockViewTop extends View {
    ...
    public GestureLockViewTop(Context context, int colorNoFingerInner, int colorNoFingerOutter, int colorFingerOn, int colorFingerUp) {
        super(context);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (mCurrentStatus) {
            case STATUS_FINGER_ON:
                Bitmap bitmap = ImageUtils.drawable2Bitmap(getResources().getDrawable(R.mipmap.gesture_press_top));
            ...
            case STATUS_FINGER_UP:
                Bitmap bitmap2 = ImageUtils.drawable2Bitmap(getResources().getDrawable(R.mipmap.gesture_press_top));
            ...
            case STATUS_NO_FINGER:
                Bitmap bitmap3 = ImageUtils.drawable2Bitmap(getResources().getDrawable(R.mipmap.gesture_no_top));
                ...
                break;
            case STATUS_ERROR:
                Bitmap bitmap4 = ImageUtils.drawable2Bitmap(getResources().getDrawable(R.mipmap.gesture_press_top));
