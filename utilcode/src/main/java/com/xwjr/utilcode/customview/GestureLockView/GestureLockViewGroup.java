...
public class GestureLockViewGroup extends RelativeLayout {
    ...
    private GestureLockViewGroupTop gestureLockViewGroupTop;//上方小的手势密码图
    /**
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                // 重置
                reset();
                if(gestureLockViewGroupTop!=null) {
                    gestureLockViewGroupTop.reset();
                }
                break;
...
//                            mOnGestureLockViewListener.onBlockSelected(cId);
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(gestureLockViewGroupTop!=null) {
                    gestureLockViewGroupTop.setMyChoose(mChoose);
                    gestureLockViewGroupTop.changeErrorMode();
                }
...
//    }
    ...
    public void setGestureLockViewGroupTop(GestureLockViewGroupTop gestureLockViewGroupTop) {
        this.gestureLockViewGroupTop = gestureLockViewGroupTop;
    }
